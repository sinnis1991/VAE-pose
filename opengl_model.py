...
class gl_ob(object):
  ...
  def __init__(self, width=128, height=128, batch_size=64, path = './generative-template/binary.stl'):
    self.width = width
    self.height = height
    ...
    self.spe_points = [ [-37.5, 16, -36.5], [-36.5, 16, -37.5],
    [-37.5, 0,  -36.5],
    [-36.5, 0,  -37.5],
    [36.5,  16, -37.5],
    [37.5,  16, -36.5],
  ...
  def out_put_fast(self,window_side=480,if_write = False,if_seed = False):

    tmp_arr_set = self.dynamic_sence(if_seed = if_seed)
